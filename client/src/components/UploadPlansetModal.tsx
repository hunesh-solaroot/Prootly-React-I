          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    {form.formState.errors.mountType && (
                      <span className="text-sm text-red-500">{form.formState.errors.mountType.message}</span>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Enter Governing Codes"
                      className="mt-1"
                    />
                  </div>

                  <div>
                    <Label htmlFor="propertyType" className="text-sm font-medium text-gray-700 dark:text-gray-300">Property Type *</Label>
                    ...
                    {form.formState.errors.propertyType && (
                      <span className="text-sm text-red-500">{form.formState.errors.propertyType.message}</span>
                    )}
                  </div>

                  <div>
                    <Label htmlFor="jobType" className="text-sm font-medium text-gray-700 dark:text-gray-300">Job Type *</Label>
                    <Select onValueChange={(value) => form.setValue("jobType", value)}>
                      <SelectTrigger className="mt-1">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="both">PV + Battery</SelectItem>
                      </SelectContent>
                    </Select>
                    {form.formState.errors.jobType && (
                      <span className="text-sm text-red-500">{form.formState.errors.jobType.message}</span>
                    )}
                  </div>

                  <div className="flex items-center space-x-2">
                    <Switch
                      checked={form.watch("newConstruction")}
                      onCheckedChange={(checked) => form.setValue("newConstruction", checked)}
                    />
                    <Label htmlFor="newConstruction" className="text-sm font-medium text-gray-700 dark:text-gray-300">New Construction</Label>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                <h3 className="text-base font-medium text-blue-800 dark:text-blue-300 mb-4">Equipment Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Module Section */}
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Solar Modules</h4>
                    <div className="space-y-3">
                      <div>
                        ...
                        <Input
                          {...form.register("moduleManufacturer")}
                      ...
                      <div>
                        ...
                        <Input
                          {...form.register("moduleModelNo")}
                          placeholder="Enter Model Number"
                          className="mt-1"
                        />
                      </div>
                      <div>
                        <Label htmlFor="moduleQuantity" className="text-sm font-medium text-gray-700 dark:text-gray-300">Module Quantity</Label>
                        <Input
                          type="number"
                  ...
                  {/* Inverter Section */}
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Inverters</h4>
                    <div className="space-y-3">
                      <div>
                        ...
                        <Input
                          {...form.register("inverterManufacturer")}
                          placeholder="Enter Manufacturer"
                          className="mt-1"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          {...form.register("inverterModelNo")}
                          placeholder="Enter Model Number"
                          className="mt-1"
                        />
                      </div>
                      <div>
                        <Label htmlFor="inverterQuantity" className="text-sm font-medium text-gray-700 dark:text-gray-300">Inverter Quantity</Label>
                        <Input
                          type="number"
                ...
                <div className="mt-4 flex items-center space-x-2">
                  <Switch
                    checked={form.watch("existingSolarSystem")}
                    onCheckedChange={(checked) => form.setValue("existingSolarSystem", checked)}
                  />
                  <Label htmlFor="existingSolarSystem" className="text-sm font-medium text-gray-700 dark:text-gray-300">Existing Solar System</Label>
                </div>
              </div>

              {/* File Uploads */}
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-6">
                <h3 className="text-base font-medium text-purple-800 dark:text-purple-300 mb-4">File Attachments</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Proposal Files */}
                  <div>
                    <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">Proposal & Design Files</Label>
                    <div className="mt-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
                      ...
                      {proposalFiles.length > 0 && (
                        <div className="mt-2">
                          <p className="text-xs text-gray-600 dark:text-gray-400">{proposalFiles.length} file(s) selected</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {/* Site Survey Files */}
                  <div>
                    <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">Site Survey Attachments</Label>
                    <div className="mt-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
                      <input
                        type="file"
                        multiple
                        ...
                        className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100"
                      />
                      {sitesurveyFiles.length > 0 && (
                        <div className="mt-2">
                          <p className="text-xs text-gray-600 dark:text-gray-400">{sitesurveyFiles.length} file(s) selected</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              {/* Additional Comments */}
              <div>
                <Label htmlFor="additionalComments" className="text-sm font-medium text-gray-700 dark:text-gray-300">Additional Comments</Label>
                <Textarea
            ...
            <div className="flex justify-end pt-6 border-t border-gray-200 dark:border-gray-700">
              <div className="flex gap-3">
                ...
                >
                  {createPlansetMutation.isPending ? "Uploading..." : "Upload Planset"}
                </Button>
              </div>
            </div>
          </form>
